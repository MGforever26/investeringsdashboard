(function(){
  ...
  function betterCategory(name,cat){
    ...
    if(inList(n,['sesamfrø','sesamfro','peanuts','honning','hasselnødder','hasselnodder','mandler','rosiner','pinjekærner','pinjekaerner','karry','spidskommen','spidskommenfrø','spidskommenfro','kardemomme','stødt koriander','stodt koriander','gurkemeje','sennepsfrø','sennepsfro','kanel','krydderier','lauerbærblade','lauerbaerblade','laurbærblade','laurbaerblade'])) return 'mel og gryn';
